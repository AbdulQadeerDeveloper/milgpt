  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-white">
      ...
      <div className="w-full bg-gradient-to-r from-[#4A6B48] via-[#395438] to-[#2A3C29] py-16 text-center shadow-lg">
        <h1 className="text-5xl font-extrabold tracking-wide">MilGPT</h1>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <form
          ...
          className="w-full max-w-lg bg-[#111113] border border-white/10 rounded-2xl p-8 shadow-2xl space-y-6"
        >
